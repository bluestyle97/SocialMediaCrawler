...
This module stores configurations for spiders.
...
weibo_user_homepage_url = 'https://m.weibo.cn/api/container/getIndex?uid={uid1}&luicode=10000012&type=uid&value={uid2}'
...
weibo_user_following_url = 'https://m.weibo.cn/api/container/getSecond?containerid=100505{uid}_-_FOLLOWERS&page={page}'
weibo_user_follower_url = 'https://m.weibo.cn/api/container/getSecond?containerid=100505{uid}_-_FANS&page={page}'
...
zhihu_user_following_url = 'https://www.zhihu.com/api/v4/members/{user}/followees?' \
                         'include={include}&offset={offset}&limit={limit}'
zhihu_user_follower_url = 'https://www.zhihu.com/api/v4/members/{user}/followers?' \
                           'include={include}&offset={offset}&limit={limit}'
...
zhihu_user_question_url = 'https://www.zhihu.com/api/v4/members/{user}' \
                           '/questions?offset={offset}&limit={limit}'
zhihu_answer_url = 'https://www.zhihu.com/api/v4/answers/{id}?include={include}'
zhihu_user_answer_url = 'https://www.zhihu.com/api/v4/members/{user}' \
                         '/answers?offset={offset}&limit={limit}'
zhihu_question_answer_url = 'https://www.zhihu.com/api/v4/questions/{id}' \
                             '/answers?offset={offset}&limit={limit}'
...
zhihu_following_query = 'data[*].answer_count,articles_count,gender,follower_count,is_followed,is_following,badge'
zhihu_follower_query = 'data[*].answer_count,articles_count,gender,follower_count,is_followed,is_following,badge'
...
tieba_user_homepage_url = 'http://tieba.baidu.com/home/main?ie=utf-8&un={user}&fr=itb'
tieba_user_following_url = 'http://tieba.baidu.com/i/i/concern?u={portrait}&pn={page}'
